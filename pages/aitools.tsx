...
export default function AITools() {
  ...
  return (
    <>
      ...
      <section className="py">
        <h1 className="text-center font-bold text-gray-800 text-4xl  mb-8 mt-2">List of AI Tools</h1>
        ...
        <div className="mx-auto grid max-w-screen-lg justify-center px-4 sm:grid-cols-2 sm:gap-4 sm:px-8 md:grid-cols-3">
          {articles.map((article, index) => (
            <article
              key={index}
              className="mx-auto my-4 flex w-full flex-col overflow-hidden rounded-2xl border border-gray-300 bg-white text-gray-900 ease-in-out transform hover:-translate-y-2 hover:shadow-2xl"
            >
