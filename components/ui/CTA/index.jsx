...
const CTA = () => {
  ...
  const handleGetStartedClick = () => {
            ...
            <div className="custom-screen flex flex-col-reverse gap-x-12 justify-between md:flex-row md:items-center">
                <div className="flex-none max-w-xl mt-12 space-y-3 md:mt-0">
                    <h2 className="text-gray-800 text-3xl font-semibold sm:text-4xl">
                        Maximize Your Product's Reach - Simply Submit Your URL
                    </h2>
    ...
    Buzzing  <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#9867F0] to-[#ED4E50]"> Feedback </span> from Regular Users of  <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#9867F0] to-[#ED4E50]">Directories</span>
