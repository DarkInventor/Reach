    ...
    const features = [
        {
            ...
            title: "High-Quality Directories",
            desc: "Get listed on our carefully curated and high-traffic directories. Gain visibility among industry peers, enthusiasts, and potential customers seeking cutting-edge websites and solutions."
        },
        {
            icon:
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            desc: "Reach a niche audience that is specifically interested in related technologies. Directories attract visitors looking for resources, services, and innovations, ensuring your website gets targeted traffic with genuine interest in your offerings."
        },
        {
            icon:
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            desc: "Benefit from valuable backlinks to your website from reputable directories. This not only boosts your website's search engine rankings but also drives organic traffic as users discover your website through multiple channels."
        },
        {
            icon:
            ...
            desc: "Access detailed analytics and insights about the traffic coming from directories. Understand user behavior, referral sources, and engagement metrics to fine-tune your website's strategy for maximum impact and continuous growth."
        },
    ]
            ...
            <div className="custom-screen text-gray-300 justify-between gap-24 lg:flex">
                <div className="max-w-xl">
                    <h2 className="text-white text-10xl font-semibold sm:text-4xl">
                        We Supercharge Your Reach Using 
                    </h2>
                    {/* <p className="mt-3">
