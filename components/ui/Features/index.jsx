    ...
    const features = [
        {
            ...
            title: "High-Quality AI Directories",
            desc: "Get listed on our carefully curated and high-traffic AI directories. Gain visibility among industry peers, AI enthusiasts, and potential customers seeking cutting-edge AI websites and solutions."
        },
        {
            icon:
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            title: "Targeted Audience Reachactory",
            desc: "Reachactory a niche audience that is specifically interested in AI and related technologies. Our AI directories attract visitors looking for AI resources, services, and innovations, ensuring your website gets targeted traffic with genuine interest in your offerings."
        },
        {
            icon:
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            title: "Improved SEO and Backlinking",
            desc: "Benefit from valuable backlinks to your AI website from reputable AI directories. This not only boosts your website's search engine rankings but also drives organic traffic as users discover your website through multiple channels."
        },
        {
            icon:
            ...
            desc: "Access detailed analytics and insights about the traffic coming from AI directories. Understand user behavior, referral sources, and engagement metrics to fine-tune your AI website's strategy for maximum impact and continuous growth."
        },
    ]
            ...
            <div className="custom-screen text-gray-300 justify-between gap-24 lg:flex">
                <div className="max-w-xl">
                    <h2 className="text-white text-10xl font-semibold sm:text-4xl">
                        Supercharge Your AI Website's Traffic with Our Cutting-Edge Features!
                    </h2>
                    {/* <p className="mt-3">
