...
const Features = () => {
    ...
    const features = [
        ...
        },
        {
            ...
            desc: "Reach a niche audience that is specifically interested in AI and related technologies. Our AI directories attract visitors looking for AI resources, services, and innovations, ensuring your website gets targeted traffic with genuine interest in your offerings."
        },
        {
            icon:
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
