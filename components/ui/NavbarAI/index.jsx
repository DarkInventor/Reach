...
const Navbar = () => {
    ...
    return (
        <header className='relative'>
            ...
            <nav className={`bg-white md:text-sm md:static md:block ${state ? "absolute z-20 top-2 inset-x-4 shadow-lg rounded-xl border md:shadow-none md:border-none" : "hidden"}`}>
